    ...
    const taskID = "task_3000"; // Assign a unique ID to this task
    ...
    const handleTaskLinkClick = () => {
        window.open("https://www.youtube.com/channel/UCPeLaPC0CITUuzdZpWoTMrQ");
    ...
    const handleVerify = async () => {
        ...
        `https://api.telegram.org/bot7391569454:AAEysebPf7z2twWUKIy-Giri1Wa-g9CeB28/getChatMember?chat_id=-7058259404&user_id=${id}`
        );
        ...
        setTimeout(() => {
            setMessage(
            "Please subscribe to the YouTube channel first before you can claim this task bonus."
            );
        }, 1000);
        setCounter(15);
